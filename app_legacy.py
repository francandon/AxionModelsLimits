...
if 'pyodide' in sys.modules:
    ...
    if not os.path.exists('./PlotFuncs.py') or not os.path.exists('./styling.py'):
        try:
...
from styling import RAW_CSS, build_equations_pane
...
equations_pane = build_equations_pane(models)
