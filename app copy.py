...
categories = {
    ...
    "Helioscopes": [
        ...
        {"name": "NuSTAR as Axion Helioscope",    "fn": AxionPhoton.NuSTAR_Sun},
    ],
    # --------------------------------------------------------------
    #  HALOSCOPES (DM DIRECT DETECTION)
    # --------------------------------------------------------------
    "Dark Matter Axions": [
    ...
    # --------------------------------------------------------------
    #  COLLIDER + LSW EXPERIMENTS
    # --------------------------------------------------------------
    "Laboratory Bounds": [
        {"name": "Light-Shining-Through-Wall", "fn": AxionPhoton.LSW},
